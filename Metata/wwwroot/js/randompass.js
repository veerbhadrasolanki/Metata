const password = document.querySelector(".password-box input"),
    copywithme = document.querySelector(".password-box .copy-icon"),
...
const generatePass = () => {
    ...
    //copywithme.classList.replace("uil-file-check-alt", "uil-copy"); //replace icon
};
...
//copy passInput's value on copywithme click
//copy passInput's value on copywithme click
//copywithme.addEventListener("click", () => {
//    navigator.clipboard.writeText(password.value);
//  //  copywithme.classList.replace("uil-copy", "uil-file-check-alt"); //replace icon
//});
